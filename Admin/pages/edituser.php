...
if (@$_SESSION['kennstravel']){
  ...
  <?php
  $ambilid = $_GET['id'];
    $res = $cn->query("SELECT * FROM user WHERE id='$ambilid'");
    $data = $res->fetch_array(MYSQLI_ASSOC);
  if (isset($_POST['Edit'])){
      $password = $_POST['password'];
      $username = $_POST['username'];
      $fullname = $_POST['fullname'];
      $update = $cn->query("UPDATE user SET id='$id', password='$password', username='$username', fullname='$fullname' WHERE id='$ambilid'");
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="inputuser.php"><i class="fa fa-circle-o"></i> Input User</a></li>
            ...
            <form role="form" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="varchar" id="fullname" class="form-control" id="fullname" placeholder="Full Name" name="fullname" value="<?php echo $data['fullname']?>">
                </div>
              </div>
