  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="daftarreservation.php"><i class="fa fa-circle-o"></i> Daftar Reservation</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Reservation</li>
    </ol>
  </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Reservation</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                        ...
                        <tbody>
                          <?php
                          require "../connect.php";
                          $sql = mysqli_query($cn, "SELECT * FROM reservation");
                            ...
                            while($row = mysqli_fetch_assoc($sql)){
                              ...
                              <tr>
                                <td>'.$id.'</td>
                                  ...
                                  <td>'.$row['price'].'</td>
                                  <td>'.$row['userid'].'</td>
                                  <td>'.$row['reservation_at'].'</td>
                                <td>';
                                  echo '
                                  <center>
                                    <a href="editreservation.php?id='.$row['id'].'"title="Edit" class="btn btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                    <a href="deletereservation.php?aksi=delete&id='.$row['id'].'"title="Hapus" onclick="return confirm(\'Data Akan Dihapus?\')"class="btn btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                  </td>
                                </tr>
                                ';
                                $id++;
