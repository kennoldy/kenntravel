    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="daftaruser.php"><i class="fa fa-circle-o"></i> Daftar User</a></li>
        </ul>
      </li>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Data User</li>
    </ol>
  </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="inputuser.php" class="btn btn-sm" title="Input User"><i class="fa fa-plus"></i></a><br>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                        ...
                        <tbody>
                          <?php
                          require "../connect.php";
                          $sql = mysqli_query($cn, "SELECT * FROM user");
                            ...
                            while($row = mysqli_fetch_assoc($sql)){
                              ...
                              <tr>
                                ...
                                <td>';
                                  echo '
                                  <center>
                                    <a href="edituser.php?id='.$row['id'].'"title="Edit" class="btn btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                    <a href="deleteuser.php?aksi=delete&id='.$row['id'].'"title="Hapus" onclick="return confirm(\'Data Akan Dihapus?\')"class="btn btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                  </td>
                                </tr>
                                ';
                                $id++;
