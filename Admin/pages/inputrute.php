...
if (@$_SESSION['kennstravel']){
  ...
  if (isset($_POST['Input'])){
      ...
      $price = $_POST['price'];
      $cn->query("INSERT INTO rute (depart_at,rute_from,rute_to,price) VALUES ('$depart_at','$rute_from','$rute_to','$price')");
            ...
            <form role="form" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="waktu" placeholder="dd/mm/yyyy" name="depart_at">
                </div>
                <div class="form-group">
                  <label for="keberangkatan">Keberangkatan</label>
                  <input type="text" class="form-control" id="keberangkatan" placeholder="Kota Keberangkatan" name="rute_from">
                </div>
                <div class="form-group">
                  <label for="tujuan">Tujuan</label>
                  <input type="text" id="tujuan" class="form-control" id="tujuan" placeholder="Kota Tujuan" name="rute_to">
                </div>
                <div class="form-group">
                  <label for="harga">Harga</label>
                  <input type="text" id="harga" class="form-control" id="harga" placeholder="Harga" name="price">
                </div>
              </div>
