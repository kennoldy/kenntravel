...
if (@$_SESSION['kennstravel']){
  ...
  <?php
  $ambilid = $_GET['id'];
    $res = $cn->query("SELECT * FROM customer WHERE id='$ambilid'");
  ...
  if (isset($_POST['Edit'])){
     $id = $_POST['id'];
      ...
      $phone = $_POST['phone'];
      $gender = $_POST['gender'];
      $update = $cn->query("UPDATE customer SET id='$id', name='$name', address='$address', phone='$phone', gender='$gender' WHERE id='$ambilid'");
            ...
            <form role="form" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Full Name" name="name" value="<?php echo $data['name']?>">
                </div>
                <div class="form-group">
                  <label for="address">Address</label>
                  <input type="text" id="address" class="form-control" id="address" placeholder="Address" name="address" value="<?php echo $data['address']?>">
                </div>
                <div class="form-group">
                  <label for="phone">Phone</label>
                  <input type="text" id="phone" class="form-control" id="phone" placeholder="Phone Number (ex: +62xxxx)" name="phone" value="<?php echo $data['phone']?>">
                </div>
                <div class="form-group" draggable="true">
                <label for="phone">Gender</label>
                <div class="form-control" name="gender" value="<?php echo $data['gender']?>">
                  <input type="radio" name="gender" value="Pria">Pria
                  <input type="radio" name="gender" value="Wanita">Wanita</div>
              </div>
              </div>
