...
if (@$_SESSION['kennstravel']){
  ...
  if (isset($_POST['Input'])){
      ...
      $cn->query("INSERT INTO user (password,username,fullname) VALUES ('$password','$username','$fullname')");
            ...
            <form role="form" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" function="md5" class="form-control" id="password" placeholder="Password" name="password">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="varchar" id="fullname" class="form-control" id="fullname" placeholder="Full Name" name="fullname">
                </div>
