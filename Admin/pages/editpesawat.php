...
if (@$_SESSION['kennstravel']){
  ...
  <?php
  $ambilid = $_GET['id'];
    $res = $cn->query("SELECT * FROM transportation WHERE id='$ambilid'");
  ...
  if (isset($_POST['Edit'])){
      ...
      $update = $cn->query("UPDATE transportation SET id='$id', code='$code', description='$description', seat_qty='$seat_qty', transportation_typeid='$transportation_typeid' WHERE id='$ambilid'");
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="inputcustomer.php"><i class="fa fa-circle-o"></i> Input Data Customer</a></li>
            ...
            <form role="form" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="code" placeholder="Airplane's Code (ex: ARP_001)" name="code" value="<?php echo $data['code']?>">
                </div>
                <div class="form-group">
                  <label for="description">Description</label>
                  <input type="text" class="form-control" id="description" placeholder="About The Airplane" name="description" value="<?php echo $data['description']?>">
                </div>
                <div class="form-group">
                  <label for="seat_qty">Seat Quantity</label>
                  <input type="number" id="seat_qty" class="form-control" id="seat_qty" placeholder="Airplane's Seat Quantity" name="seat_qty" value="<?php echo $data['seat_qty']?>">
                </div>
                <div class="form-group">
                  <label for="transportation_typeid">Transportation</label>
                  <input type="text" id="transportation_typeid" class="form-control" id="transportation_typeid" placeholder="Airplane's ID Type" name="transportation_typeid" value="<?php echo $data['transportation_typeid']?>">
                </div>
              </div>
