...
if (@$_SESSION['kennstravel']){
  ...
  if (isset($_POST['Input'])){
      ...
      $phone = $_POST['phone'];
      $gender = $_POST['gender'];
      $cn->query("INSERT INTO customer (id,name,address,phone,gender) VALUES ('$id','$name','$address','$phone','$gender')");
            ...
            <form role="form" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="address" class="form-control" id="address" placeholder="Address" name="address">
                </div>
                <div class="form-group">
                  <label for="phone">Phone</label>
                  <input type="text" id="phone" class="form-control" id="phone" placeholder="Phone Number (ex: +62xxxx)" name="phone">
                </div>
