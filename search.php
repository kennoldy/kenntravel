...
<html lang="en">
<head>
<title>Welcome Kenn's Travel</title>
<!-- meta-tags -->
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<div class="w3_navigation_pos">
						<h1><a href="index.html"><span>K</span>enn's <span>T</span>ravel</a></h1>
					</div>
				</div>
...
<div class="col-md-12 footer-w3layouts">
		<div class="footer-top-agile">
		<h6><a href="index.html"><span>K</span>enn's<span>T</span>ravel</a></h6>
		<div class="footer-contact-w3ls">
			<ul>
				<li><i class="fa fa-globe" aria-hidden="true"></i>Purwokerto, Central Java, Indonesia</li>
				<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com">kennstravel@gmail.co.id</a></li>
			</ul>
		</div>
		<div class="clearfix"> </div>
		<ul class="top-links">
		...
		<div class="footer-bottom-wthree">
			<div class="copyright-wthree">
				<p><center>&copy; 2018 Kenn's Travel All Rights Reserved | Design by Kennoldy</center></p>
